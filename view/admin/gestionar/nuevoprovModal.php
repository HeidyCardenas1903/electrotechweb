...
<div class="modal fade" id="nuevoprovModal" tabindex="-1" aria-labelledby="nuevoprovModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-center" id="nuevoprovModalLabel"><i class="fa-solid fa-user-plus"></i> Nuevo registro | Proveedores </h1>
