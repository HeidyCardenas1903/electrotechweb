...
<div class="modal fade" id="nuevousuModal" tabindex="-1" aria-labelledby="nuevousuModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-center" id="nuevousuModalLabel"><i class="fa-solid fa-user-plus"></i> Nuevo registro | Usuarios </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="guardausu.php" method="POST">
