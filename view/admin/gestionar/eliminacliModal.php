...
<div class="modal fade" id="eliminacliModal" tabindex="-1" aria-labelledby="eliminacliModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-mb">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-center" id="eliminacliModalLabel"><i class="fa-solid fa-circle-exclamation"></i> Advertencia de eliminación </h1>
